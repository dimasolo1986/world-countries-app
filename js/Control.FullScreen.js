...
(function (root, factory) {
  ...
  leaflet.Control.FullScreen = leaflet.Control.extend({
    ...
    _createOriginalZoomButton(
      ...
      this.zoom.innerHTML = content;

      this.zoom.setAttribute("role", "button");
      this.zoom.setAttribute("aria-label", title);

      L.DomEvent.disableClickPropagation(container);

      leaflet.DomEvent.on(this.zoom, "click", leaflet.DomEvent.stop).on(
        this.zoom,
        "click",
        fn,
        context
    ...
    setOriginalZoom() {
      const map = this._map;
      map.fitBounds([
        [73.1217211716937, 221.48437500000003],
        [-65.37146534864254, -140.27343750000003],
      ]);
    },
